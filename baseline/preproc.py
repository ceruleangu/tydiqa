...
def convert_single_example(tydi_example,
                           tokenizer,
                           is_training,
                           max_question_length,
                           max_seq_length,
  ...
  all_doc_wp = contexts_wordpieces
  offset_to_wp = contexts_offset_to_wp
  ...
  if is_training:
    ...
    # end offset isn't inclusive,
    # thus we take the wordpiece index of end_offset -1.
    ...
    wp_start_position = find_nearest_wordpiece_index(
        tydi_example.start_byte_offset, offset_to_wp, True)
    wp_end_position = find_nearest_wordpiece_index(
        tydi_example.end_byte_offset - 1, offset_to_wp, False)
